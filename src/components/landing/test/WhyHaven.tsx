...
export default function WhyHaven() {
    return (
        <section id="why-haven" className="py-32 bg-[#FDFBF7] relative overflow-hidden">
            <div className="container mx-auto px-6 max-w-5xl relative z-10">
                ...
                <div className="text-center mb-24">
                    ...
                    >
                        ...
                        <span className="text-[10px] font-bold text-stone-500 tracking-[0.2em] uppercase">Why Haven</span>
                    </motion.div>
                    <motion.h2
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-12 gap-4 mb-8 px-6 hidden md:grid">
                        ...
                        <div className="col-span-4 text-center">
                            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-emerald-600">Haven AI</span>
                        </div>
                        <div className="col-span-4 text-center">
                        ...
                        {comparisons.map((row, i) => (
                            ...
                            >
                                ...
                                <div className="md:col-span-4 flex items-center justify-center gap-3">
                                    <div className="md:hidden text-[9px] font-bold uppercase tracking-widest text-emerald-600 mb-1 w-full text-center">Haven AI</div>
                                    <div className="flex items-center gap-2.5 px-4 py-2 bg-emerald-50/50 rounded-full border border-emerald-100/50">
                                        <Check className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
                                        <span className="text-sm text-stone-600 font-medium">{row.haven}</span>
                                    </div>
                                </div>
