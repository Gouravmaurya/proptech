...
export default function PhilosophySection() {
    ...
    const TEXT =
        "We believe a home is more than a structure. It's the silent witness to your life's greatest moments. A sanctuary for growth, a canvas for memories, and a proptech for the soul.";
